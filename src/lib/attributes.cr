...
lib LibGit
  ...
  fun attr_get = git_attr_get(value_out : LibC::Char**, repo : Repository, flags : UInt32, path : LibC::Char*, name : LibC::Char*) : LibC::Int
  # Look up a list of git attributes for path.
  fun attr_get_many = git_attr_get_many(values_out : LibC::Char**, repo : Repository, flags : UInt32, path : LibC::Char*, num_attr : LibC::SizeT, names : LibC::Char**) : LibC::Int
  # Loop over all the git attributes for a path.
  fun attr_foreach = git_attr_foreach(repo : Repository, flags : UInt32, path : LibC::Char*, callback : AttrForeachCb, payload : Void*) : LibC::Int
