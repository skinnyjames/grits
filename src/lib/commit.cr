...
lib LibGit
  ...
  fun commit_parent = git_commit_parent(buffer : Commit*, commit : Commit, n : LibC::UInt) : LibC::Int
  ...
  fun commit_header_field = git_commit_header_field(buffer : Buf*, commit : Commit, field : LibC::Char*) : LibC::Int
  ...
  fun commit_create_buffer = git_commit_create_buffer(buffer : Buf*, repo : Repository, author : Signature*, committer : Signature*, message_encoding : LibC::Char*, message : LibC::Char*, tree : Tree, parent_count : LibC::SizeT, parents : Commit*) : LibC::Int
  fun commit_create_with_signature = git_commit_create_with_signature(oid : Oid*, repo : Repository, commit_content : LibC::Char*, signature : LibC::Char*, signature_field : LibC::Char*) : LibC::Int
  fun commit_dup = git_commit_dup(commit : Commit*, source : Commit) : LibC::Int
end
